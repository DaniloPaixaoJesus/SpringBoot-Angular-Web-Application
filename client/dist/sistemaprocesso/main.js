...
var FormLegalAdviceComponent = /** @class */ (function () {
    function FormLegalAdviceComponent(route, router, legalAdviceService, userService) {
        this.route = route;
        this.router = router;
    ...
    FormLegalAdviceComponent.prototype.ngOnInit = function () {
        ...
        this.route.paramMap.subscribe(function (params) {
            if (params.get('id')) {
                _this.legalAdviceId = Number(params.get('id'));
                _this.legalAdviceService.getLegalAdviceById(_this.legalAdviceId).subscribe(function (p) {
                    console.log('getProcessById==>', p);
                    _this.legalAdvice = p;
                });
            }
            else {
                _this.legalAdvice = new _services_legal_advice_legal_advice_model__WEBPACK_IMPORTED_MODULE_3__["LegalAdvice"]();
            }
        });
    ...
    FormLegalAdviceComponent.prototype.redirectProcess = function () {
...
var FormProcessComponent = /** @class */ (function () {
        ...
        this.route.paramMap.subscribe(function (params) {
            if (params.get('id')) {
                ...
                _this.processService.getProcessById(_this.processId).subscribe(function (p) {
                    console.log('getProcessById==>', p);
                    _this.process = p;
                    _this.listLegalAdvice = p.legalAdvices;
                });
            }
            else {
    ...
    FormProcessComponent.prototype.redirectLegalAdvice = function (id) {
        this.router.navigate(["/legalAdvice/form/" + id]);
    };
...
module.exports = __webpack_require__(/*! /Users/user/meus-projetos/github-repository/SpringBoot-React-Web-Application/client/src/main.ts */"./src/main.ts");
